...
def _update_via_zip(args):
    ...
    if branch != "main":
        ...
        sys.exit(1)
    zip_url = (
        f"https://github.com/harborworks/harbor-hermes-agent/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/harborworks/harbor-hermes-agent.git",
    "git@github.com:harborworks/harbor-hermes-agent.git",
    "https://github.com/harborworks/harbor-hermes-agent",
    "git@github.com:harborworks/harbor-hermes-agent",
}
OFFICIAL_REPO_URL = "https://github.com/harborworks/harbor-hermes-agent.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from harborworks/harbor-hermes-agent.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/harborworks/harbor-hermes-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/harborworks/harbor-hermes-agent.git' to add later."
            )
...
def _cmd_update_check(branch: str = "main", *, branch_explicit: bool = False):
    ...
    # Harbor Works installs should follow their configured origin. Existing
    # developer checkouts may still have an upstream remote that points to the
    # old Nous repo, so do not prefer upstream merely because it exists.
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    if not git_dir.exists():
        if sys.platform == "win32":
            ...
            print(
                "  curl -fsSL https://raw.githubusercontent.com/harborworks/harbor-hermes-agent/main/scripts/install.sh | bash"
            )
            sys.exit(1)
