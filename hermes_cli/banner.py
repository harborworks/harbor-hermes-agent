...
_UPSTREAM_REPO_URL = "https://github.com/harborworks/harbor-hermes-agent.git"
...
_RELEASE_URL_BASE = "https://github.com/harborworks/harbor-hermes-agent/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical Harbor Works Hermes repo (forks don't get a link).
    """
