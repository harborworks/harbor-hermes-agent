...
def build_models_payload(
    ...
    *,
    ...
    Flags:
    - ``include_unconfigured``: append visible canonical provider rows that
    ...
    - ``canonical_order``: reorder visible canonical-slug rows to declaration
      order; truly-custom rows go last.
    """
