...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/harborworks/harbor-hermes-agent/harbor-latest/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:harborworks/harbor-hermes-agent.git"
REPO_URL_HTTPS="https://github.com/harborworks/harbor-hermes-agent.git"
