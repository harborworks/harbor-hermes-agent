...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Harbor Works look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Harbor Works need to see?`,
    ...
    {
      headline: `What should ${label} Harbor Works tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        ...
        >
          <span>
            <span>HARBOR WORKS</span>
          </span>
          <span aria-hidden="true">HARBOR WORKS</span>
        </p>
