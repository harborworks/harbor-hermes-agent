 ...
 *
 * Stamps the Harbor Works icon + identity onto the packed Windows app exe via
 ...
 *   - packager.appInfo.productFilename: the exe basename (e.g. 'Harbor Works')
 */
...
exports.default = async function afterPack(context) {
  ...
  const productName = context.packager?.appInfo?.productFilename || 'Harbor Works'
